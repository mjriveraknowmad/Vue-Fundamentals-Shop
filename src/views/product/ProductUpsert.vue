        ...
        <form v-on:submit.prevent="handleSubmit">
          ...
          <div class="mb-3">
            ...
            <div class="input-group">
              <input type="file" class="form-control" @change="handleImageUpload" :disable="isImageLoading" />
            </div>
          </div>
          <div class="pt-3">
            ...
            <router-link :to="{ name: APP_ROUTE_NAMES.PRODUCT_LIST }" class="btn btn-secondary m-2 w-25">
              Cancel
            </router-link>
          </div>
        </form>
...
async function handleSubmit() {
  try {
    loading.value = true
    errorList.length = 0 // limpiamos los errores anteriores
